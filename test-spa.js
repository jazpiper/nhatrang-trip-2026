...
class TestRunner {
  ...
  summary() {
    ...
    console.log(`${colors.bright}Spa Test Execution Summary (${duration}s)${colors.reset}`);
    console.log(`====================================================`);
    ...
    if (this.failedTests > 0) {
      ...
      console.log(`\n${colors.red}❌ Spa Test Suite Failed.${colors.reset}\n`);
      return false;
    } else {
      console.log(`\n${colors.green}${colors.bright}✨ All Spa Test Suites Passed Successfully! 100% Schema & Data Integrity Verified.${colors.reset}\n`);
      return true;
    }
  }
}
