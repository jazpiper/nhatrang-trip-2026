/**
 * Nha Trang Activity Dataset (32 Verified Tour & Marine Activities)
 * Curated for Nha Trang, Vietnam.
 * 100% Real-World Verified Ground-Truth Activities (Excludes Spas & Mudbaths)
 */
...
const NHA_TRANG_ACTIVITIES = [
  ...
  },
  {
    ...
    "notIncluded": [
      "이동 그랩 비용 (시내에서 편도 5~6만 동)",
      "사원 내 소원 초 구매"
    ],
    "whatToBring": [
      "무릎과 어깨를 가리는 얇은 린넨 셔츠/로브 (사원 내부 입장 시 필요)",
      "양산 또는 모자"
    ],
  ...
  },
  {
    ...
    "notIncluded": [
      "카페 음료 주문 비용",
      "교통비 (시내에서 그랩 편도 약 5~6만 동)"
    ],
    "whatToBring": [
      "편한 샌들/운동화 (바위 위 미끄럼 주의)",
      "선글라스 & 양산",
      "스마트폰 카메라 완충"
    ],
  ...
  },
  {
    ...
    "notIncluded": [
      "정문 주변 비공식 호객/가이드 팁 요구 (무시 권장)"
    ],
    "whatToBring": [
      "단정한 복장 (민소매/초미니스커트 지양)",
      "카메라"
    ],
  ...
  },
  {
    ...
    "notIncluded": [
      "개인 간식 및 음료",
      "원숭이 간식(바나나/땅콩) 개별 구매 (약 1~2만 동)"
    ],
    "whatToBring": [
      "모자 & 선글라스",
      "소지품 잠금 가능한 가방 (원숭이가 물건을 낚아챌 수 있음)",
      "물티슈"
    ],
  ...
  },
  {
    ...
    "notIncluded": [
      "개인 쇼핑 및 음식 구매비 (현금 결제 권장)"
    ],
    "whatToBring": [
      "소액 베트남 동 현금 (1만~5만 동 권종)",
      "크로스백 (소매치기 주의)"
    ],
...
if (typeof window !== 'undefined') {
  window.NHA_TRANG_ACTIVITIES = NHA_TRANG_ACTIVITIES;
  window.DEFAULT_EXCHANGE_RATE = DEFAULT_EXCHANGE_RATE;
}
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { NHA_TRANG_ACTIVITIES, DEFAULT_EXCHANGE_RATE };
}
