...
const runner = new TestRunner({
  summaryTitle: 'Currency & ATM Test Execution Summary',
  failureHeader: (failedTests) => `Failures & Discrepancies Detected (${failedTests}):`,
  failureFooter: 'Currency Test Suite Failed.',
  successMessage: (totalSuites) => `✨ All ${totalSuites} Currency & ATM Test Suites Passed Successfully! 17 Ground-Truth Places Verified.`,
  exitOnFailure: true,
  exitOnSuccess: true
});
